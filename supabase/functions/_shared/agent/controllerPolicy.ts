...
export const AGENT_CONTROLLER_INSTRUCTION = [
  ...
  'Enerjisa canonical document contract/template tek otoritedir. Canonical bölüm başlıklarını koru; legacy fallback chapter veya alternatif şablon uydurma. Artifact renderer/validator hangi canonical contractı veriyorsa onu uygula.',
