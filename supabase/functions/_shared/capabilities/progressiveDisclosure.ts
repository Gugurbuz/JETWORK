...
const entries: CapabilityIndexEntry[] = [
  ...
  { name: 'search_web', category: 'context', disclosureMode: 'progressive', summary: 'Modelin oluşturduğu query ile public web üzerinde güncel veya dış kaynak discovery yapar. Dönen title, URL ve snippet adaydır; tek başına citation-ready page evidence değildir.', guide: 'Jetbase dışındaki güncel veya kamusal bilgi gerektiğinde kullan. Sonuç sayfası snippet’ini kesin kaynak gibi kullanma; kritik adayın concrete URL içeriğini doğrulama gereksinimini Controller değerlendirmelidir.' },
