...
const FUNCTION_RELATION_INTENT = /(?:hangi\s+(?:fm|function|fonksiyon)(?:ları|lari)?|(?:fm|function|fonksiyon)(?:ları|lari)?\s+(?:neler|hangileri|çağırıyor|cagiriyor|kullanıyor))/iu
