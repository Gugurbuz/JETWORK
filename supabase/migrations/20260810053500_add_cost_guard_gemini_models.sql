-- Cost Guard v1 uses stable Flash-Lite models for orchestration and agent tool decisions.
-- Keep historical preview model values valid so existing conversations remain readable.
