...
begin
  ...
  insert into public.assistant_prompt_versions (
    ...
    v_current_prompt || E'\n\n[JETWORK PRODUCT QUALITY CONTRACT v1]\n'
      ...
      || E'- Doküman talebi bilgi yetersizliği nedeniyle netleştirme gerektiriyorsa en fazla üç kısa ve tarafsız soru sor. <jetwork_meta> içindeki bu soruların options alanı boş dizi [] olmalıdır; kullanıcıyı hazır seçeneklerle yönlendirme. "Varsayımlarla devam et" aksiyonu istemci tarafından ayrıca sunulur.\n'
