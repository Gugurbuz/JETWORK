...
export const INTENT_DEFAULTS: Partial<Record<SubIntent, IntentDefaults>> = {
  ...
  generate_technical_analysis: { impact: 'updates_document', operation: 'replace_or_create_section', risk: 'medium', targetSection: 'businessAnalysis', shouldRunBaAgentLoop: true, baAgentFocus: 'technical_analysis' },
  ...
  generate_integration_analysis: { impact: 'updates_document', operation: 'append_to_section', risk: 'medium', targetSection: 'businessAnalysis', shouldRunBaAgentLoop: true, baAgentFocus: 'technical_analysis' },
  generate_api_contract: { impact: 'updates_document', operation: 'append_to_section', risk: 'medium', targetSection: 'businessAnalysis', shouldRunBaAgentLoop: true, baAgentFocus: 'technical_analysis' },
  generate_error_scenarios: { impact: 'updates_document', operation: 'append_to_section', risk: 'medium', targetSection: 'businessAnalysis', shouldRunBaAgentLoop: true, baAgentFocus: 'test' },
  generate_test_cases: { impact: 'updates_document', operation: 'replace_or_create_section', risk: 'medium', targetSection: 'businessAnalysis', shouldRunBaAgentLoop: true, baAgentFocus: 'test' },
  generate_flow_diagram: { impact: 'updates_document', operation: 'replace_or_create_section', risk: 'medium', targetSection: 'businessAnalysis', shouldRunBaAgentLoop: true, baAgentFocus: 'flow' },
  generate_bpmn: { impact: 'updates_document', operation: 'replace_or_create_section', risk: 'medium', targetSection: 'businessAnalysis', shouldRunBaAgentLoop: true, baAgentFocus: 'flow' },
  generate_mermaid: { impact: 'updates_document', operation: 'replace_or_create_section', risk: 'medium', targetSection: 'businessAnalysis', shouldRunBaAgentLoop: true, baAgentFocus: 'flow' },
  ...
  generate_developer_handoff: { impact: 'updates_document', operation: 'append_to_section', risk: 'medium', targetSection: 'businessAnalysis', shouldRunBaAgentLoop: true },
  // Document editing
  ...
  extract_tests_from_selected_text: { impact: 'updates_document', operation: 'extract_to_another_section', risk: 'medium', targetSection: 'businessAnalysis' },
  ...
  check_testability: { impact: 'updates_document', operation: 'update_flags', risk: 'medium', targetSection: 'businessAnalysis' },
  check_traceability: { impact: 'updates_document', operation: 'update_flags', risk: 'medium', targetSection: 'businessAnalysis' },
  ...
  check_integration_completeness: { impact: 'updates_document', operation: 'update_flags', risk: 'medium', targetSection: 'businessAnalysis' },
...
export const SLASH_COMMAND_MAP: Record<string, { primary: PrimaryIntent; sub: SubIntent; target?: DocumentSectionKey }> = {
  ...
  '/test': { primary: 'analysis_generation', sub: 'generate_test_cases', target: 'businessAnalysis' },
  '/flow': { primary: 'analysis_generation', sub: 'generate_flow_diagram', target: 'businessAnalysis' },
  '/bpmn': { primary: 'analysis_generation', sub: 'generate_bpmn', target: 'businessAnalysis' },
  '/mermaid': { primary: 'analysis_generation', sub: 'generate_mermaid', target: 'businessAnalysis' },
  ...
  '/api': { primary: 'analysis_generation', sub: 'generate_api_contract', target: 'businessAnalysis' },
